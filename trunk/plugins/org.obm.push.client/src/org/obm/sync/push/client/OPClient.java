...
public class OPClient {
	...
	public Document postXml(String namespace, Document doc, String cmd,
		...
		PostMethod pm = null;
		pm = new PostMethod(ai.getUrl() + "?User=" + ai.getLogin() + "&DeviceId=" + ai.getDevId()
				+ "&DeviceType=" + ai.getDevType() + "&Cmd=" + cmd);
	...
	public byte[] postGetAttachment(String attachmentName) throws Exception {
		PostMethod pm = new PostMethod(ai.getUrl() + "?User=" + ai.getLogin() + "&DeviceId="
				+ ai.getDevId() + "&DeviceType=" + ai.getDevType()
